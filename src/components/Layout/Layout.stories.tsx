...
const Template: ComponentStory<typeof Layout> = args => (
  <Layout {...args}>
    <Typography paragraph>
      ...
      imperdiet proin fermentum leo. Mauris commodo quis imperdiet massa tincidunt. Cras tincidunt
      lobortis feugiat vivamus at augue. At augue eget arcu dictum varius duis at consectetur lorem.
...
Default.args = { title: 'Layout Story' };
